...
const sections = [
  {
    ...
    image: "/images/about/vita-piano.jpg",
  },
  {
    year: "🎶 Pierwszy chór",
    ...
    image: "/images/about/vita-chor.jpg",
  },
  {
  ...
  },
  {
    ...
    image: "/images/about/vita-workshops.jpg",
  },
  {
    year: "👩‍👦 Prywatnie",
  ...
  },
  {
    ...
    image: "/images/about/vita-future.jpg",
  },
];
    ...
    <section id="biography" className="py-20 bg-(--brand-beige)/40">
      ...
      <div className="max-w-6xl mx-auto px-6 space-y-10">
        {sections.map((section, i) => (
          ...
          >
            {section.image && (
              <div className="relative w-full md:w-1/3 h-64 sm:h-72 md:h-80 lg:h-96">
                <Image
                  src={section.image}
                  alt={section.year}
                  fill
            ...
            <div className="p-6 md:w-2/3">
              <h3 className="text-2xl font-semibold text-(--brand-rose) mb-3">
                {section.year}
              </h3>
