...
export default function Slogan() {
  return (
    <motion.div
      ...
      className="text-center py-4 bg-[var(--brand-rose)]/10 dark:bg-white/10 backdrop-blur-sm shadow-md"
    >
      <h2
        ...
        animate-gradient-x italic tracking-wide leading-relaxed pb-1 uppercase"
      >
