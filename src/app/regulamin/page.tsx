...
export default function RegulaminPage() {
  return (
    <main className="max-w-4xl mx-auto p-8 prose prose-pink">
      ...
      <p>
        ...
        prowadzonej przez Vitę – trenerkę wokalną, dostępnej pod adresem{" "}
        <a href="https://vita.pl" className="text-blue-600 underline">
          https://vita.pl
        </a>{" "}
        (dalej: „Serwis”).
      </p>
      ...
      <h2>§3 Rejestracja i płatności</h2>
      <ul>
        <li>
